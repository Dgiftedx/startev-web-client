...
@Component({
  selector: 'app-knowledge-hub-general-knowledge',
  templateUrl: './knowledge-hub-general-knowledge.component.html',
  styleUrls: ['./knowledge-hub-general-knowledge.component.css']
})
export class KnowledgeHubGeneralKnowledgeComponent implements OnInit {

  currentUser: User;

  public query = '?q=general_knowledge_areas';
